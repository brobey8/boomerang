      ...
      Beacons.startUpdatingLocation();
        ...
        var subscription = DeviceEventEmitter.addListener(
            ...
            (data) => {
                ...
                // @todo this should probably be in root component as it causes problems when we leave this view..
                this.setState({
                ...
                if(data.beacons[0]) {
                    //insert member ID
                    //ghetto forming post request
                    var payload = {
                        member_id: 1,
                        beacon_uuid: data.beacons[0].uuid,
                        beacon_major: data.beacons[0].major,
                        beacon_minor: data.beacons[0].minor,
                        rssi: data.beacons[0].rssi,
                        proximity: data.beacons[0].proximity
                    };
                    this.props.sendEventToApi(payload);
                }
            }
        );
  },
